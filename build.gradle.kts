...
kotlin {
    ...
    swiftExport {
        moduleName = "ProcMacro2"
        flattenPackage = "io.github.kotlinmania.procmacro2"
    }

    android {
        namespace = "io.github.kotlinmania.procmacro2"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "proc-macro2-kotlin", version.toString())

    pom {
        name.set("proc-macro2-kotlin")
        description.set("Kotlin Multiplatform port of dtolnay/proc-macro2 - A substitute implementation of the compiler's `proc_macro` API to decouple token-based libraries from the procedural macro use case")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/proc-macro2-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/proc-macro2-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/proc-macro2-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/proc-macro2-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleProcMacro2XCFramework",
    "assembleProcMacro2DebugXCFramework",
    "assembleProcMacro2ReleaseXCFramework",
    "assembleDebugIosFatFrameworkForProcMacro2XCFramework",
    "assembleReleaseIosFatFrameworkForProcMacro2XCFramework",
    "assembleDebugIosSimulatorFatFrameworkForProcMacro2XCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForProcMacro2XCFramework",
    "assembleDebugMacosFatFrameworkForProcMacro2XCFramework",
    "assembleReleaseMacosFatFrameworkForProcMacro2XCFramework",
    "assembleDebugTvosFatFrameworkForProcMacro2XCFramework",
    "assembleReleaseTvosFatFrameworkForProcMacro2XCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForProcMacro2XCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForProcMacro2XCFramework",
    "assembleDebugWatchosFatFrameworkForProcMacro2XCFramework",
    "assembleReleaseWatchosFatFrameworkForProcMacro2XCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForProcMacro2XCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForProcMacro2XCFramework",
