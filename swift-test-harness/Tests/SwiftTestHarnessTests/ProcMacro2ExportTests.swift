...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `ProcMacro2.swiftmodule/`
...
//      `import ProcMacro2` above would fail at compile time.
//
//   2. The static archive `libProcMacro2.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "ProcMacro2" }` and
//      `flattenPackage = "io.github.kotlinmania.procmacro2"` configuration in
...
//      via the `ProcMacro2Library` product.
//
...
final class ProcMacro2ExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "ProcMacro2 swift module imported cleanly")
    }
}
