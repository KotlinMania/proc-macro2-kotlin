...
This file is the quick-reference operating contract for proc-macro2-kotlin. The longer
...
proc-macro2-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`proc-macro2`](https://crates.io/crates/proc-macro2). Upstream Rust is the behavioral oracle while the
